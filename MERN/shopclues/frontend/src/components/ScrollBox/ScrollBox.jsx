    ...
    return (
        ...
        <Box bg={'pink'} w={'100%'} h={'25rem'} display={'flex'} flexDirection={'column'} p={'1.5rem 3rem'}>
            ...
            <Box bg={'white'} w={'100%'} h={'18.5rem'} mt={'0.6rem'} display={'flex'} position={'relative'} zIndex={1} >
                ...
                {
                    showLeftButton && (
                        <Box bg={colors.primary} h={'4rem'} w={'2.5rem'} onClick={scrollLeft} position={'absolute'} top={'7rem'} fontSize={'2.5rem'} borderRadius={'0px 4px 4px 0px'} display={'flex'} alignItems={'center'} justifyContent={'center'} color={'white'}>
                ...
                {
                    showRightButton && (
                        <Box bg={colors.primary} h={'4rem'} w={'2.5rem'} onClick={scrollRight} position={'absolute'} top={'7rem'} right={0} fontSize={'2.5rem'} borderRadius={'4px 0px 0px 4px'} display={'flex'} alignItems={'center'} justifyContent={'center'} color={'white'}>
